...
2.  **Correr el entrenamiento:**
    ...
    **Paso 2:** Abrí la notebook `02_modelado.ipynb` y ejecutá todas las celdas (**Run All**) para el Entrenamiento de modelos (Linear Regression, Random Forest, XGBoost, LightGBM) y el Registro automático de métricas en MLflow.